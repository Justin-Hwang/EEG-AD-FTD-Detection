"""
Train EEGNet using 5-fold cross-validation with class balancing.
Model Training with Cross-Validation
"""

"""
1. Loads data from model-data/labels.json.
2. Balances the classes manually (A, C, F).
3. Creates the PyTorch Dataset and 5-fold splits.
4. Trains EEGNet with:
 - Adam optimizer
 - CrossEntropy loss
 - 810 epochs

5. Uses StratifiedKFold to ensure label balance across folds.
6. Saves the model and plots loss curves for each fold.
"""
